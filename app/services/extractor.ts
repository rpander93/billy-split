...
const FORM_RECOGNIZER_URL = process.env.AZURE_FORM_RECOGNIZER_URL as string;
const FORM_RECOGNIZER_API_KEY = process.env.AZURE_FORM_RECOGNIZER_API_KEY as string;
